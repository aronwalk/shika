...
\input{./tex/starting-a-lab.tex}
\input{./tex/order-in-the-storeroom.tex}
\input{./tex/technical-lab-needs.tex}
%\input{./tex/improving-existing-labs.tex}

% Part 2 - Biology Activities
\input{./tex/part2.tex}
...
% Part 5 - Earth Science Activities
\input{./tex/part5.tex}

% Part 6 - Lab Techniques
\input{./tex/part6.tex}
